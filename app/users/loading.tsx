/**
 * Users Loading Component for Dex Real-Time Messenger
 *
 * This file provides the users loading component for our Next.js 14 real-time
 ...
 * optimal user experience during users page data fetching and navigation.
 *
 * Key Features:
 * - Next.js App Router loading.tsx pattern implementation
 * - LoadingModal component integration for consistent loading UI
 * - Route-level loading state for users page transitions
 * - Server-side data fetching loading feedback
 * - Consistent loading experience across users interface
 * - Integration with users layout and page components
 *
 * Loading Patterns:
 * - Route-level loading: Next.js loading.tsx for page transitions
 * - Server-side data fetching: getUsers action loading feedback
 * - Navigation transitions: Users page route changes
 * - Layout loading: Users layout component data fetching
 * - User experience: Consistent loading feedback throughout users interface
 *
 * This component is essential for our messaging app because it provides the
 * route-level loading state that keeps users informed during users page
 * data fetching and navigation transitions, ensuring smooth user experience
 * throughout our messaging platform.
 *
 * @fileoverview Users loading component for Next.js 14 real-time messaging application
 * @author Dayle Cortes
 * @since 2025
 */
...
/**
 * Users Loading Component
 *
 * A route-level loading component that provides loading feedback for the users
 ...
 * experience during users page data fetching and navigation transitions.
 *
 * Key Capabilities:
 * - Next.js App Router loading.tsx pattern implementation
 * - LoadingModal component integration for consistent loading UI
 ...
 *
 * Usage Patterns:
 * - Users page loading: Route-level loading for /users page transitions
 * - Server-side fetching: getUsers action loading feedback
 * - Navigation transitions: Users page route changes and navigation
 * - Layout loading: Users layout component data fetching
 * - User experience: Consistent loading feedback throughout users interface
 *
 * Next.js App Router Integration:
 * - loading.tsx pattern: Automatic loading UI for route segments
 * - Route-level loading: Loading state for entire users page
 * - Server-side data fetching: Loading feedback during getUsers action
 * - Navigation transitions: Loading state during route changes
 * - Layout integration: Loading state for users layout component
 *
 ...
 * throughout our messaging platform.
 *
 * @returns {JSX.Element} LoadingModal component for users page loading state
 *
 * @example
 * ```tsx
 * // Next.js App Router automatically uses this loading.tsx file
 * // when navigating to /users route or when users layout is loading
